...
public class CatalogServlet extends BaseServlet {
	...
	public String myCatalog(HttpServletRequest request, HttpServletResponse response)
	...
	//创建文件夹
	public String createCatalog(HttpServletRequest request, HttpServletResponse response)
		throws ServletException, IOException {
	...
	public String deleteCatalog(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
		String cid=request.getParameter("cid");
